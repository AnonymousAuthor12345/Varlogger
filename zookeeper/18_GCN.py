...
test_dataset  = MyPyGDataset(root='./all_data/graph_train')
...
if __name__ == '__main__':
    ...
    for epoch in range(200):
        ...
        with torch.no_grad():
            ...
            for batch_index, val_data in enumerate(val_loader):
                ...
                csv_name = val_data.train_name[0]
                ...
                # 根据 targets_mask 为1的索引, 取 output 中前几位有效的预测结果
    ...
    # 模型测试
    print(f"============ 模型测试训练开始 ============")
    test_model = torch.load("./model_save/GCN_model.pth")
    test_model.eval()
    ...
    with torch.no_grad():
        for batch_index, test_data in enumerate(test_loader):
            ...
            targets_mask = test_data.label_mask.to(device)
