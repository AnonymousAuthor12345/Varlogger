...
# 对复合按照Split snake_case and camelCase进行进一步划分
...
def creat_new_bytecode_tokens(token_lst):
    ...
    # 遍历每个token,把是复合词的token进一步划分
    for token in token_lst:
        simple_token_list = split_compound_word(token)  # 返回分割后的子词list
        # print("123 simple_token_list:", simple_token_list)
...
def IR_process(train_path, test_path):
    ...
    # print(test_token_list[0:3])
    # print(len(test_token_list))
