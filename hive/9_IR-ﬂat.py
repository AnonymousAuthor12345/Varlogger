...
def IR_process(train_path,test_path):
    ...
    for csv_name in train_name_list:
        ...
        # 再把每个符合词进行进一步划分
        # print("bytecode_token_list:", bytecode_token_list)
        # 对复合词进行进一步划分
    ...
    for test_index, test_name in enumerate(test_name_list):
        train_lable_dir = "./all_data/train_label"
        label_path = os.path.join(train_lable_dir, test_name)
        ...
        pred_path = os.path.join(train_lable_dir, pred_csv_name)
